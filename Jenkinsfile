            ...
            steps {
                script {
                    ...
                    if (healthStatus != 0) {
                        ...
                        echo 'Production deployment failed. Starting rollback to version 1.0...'
                        ...
                        echo 'Rollback to version 1.0 completed successfully.'

                        error('Production deployment failed, but rollback completed successfully.')
                    }
